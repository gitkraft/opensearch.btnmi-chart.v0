...
# GitKraft's `opensearch` Helm Chart
...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=opensearch.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.opensearch.btnmi-chart.v0&gk_description=Helm%20chart%20for%20opensearch%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=opensearch.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **opensearch** Helm chart, originally
